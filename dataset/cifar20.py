...
from dataset.dataset_util import check
...
def separate_data_cifar20_balance(data, num_clients, num_classes=5,  partition="dir", mapper=[]):
    ...
    if partition == "dir":
        ...
        for i in range(len(mapper)):
            ...
            cls_priors = np.random.dirichlet(alpha=[alpha] * num_classes, size=num_clients)
...
if __name__ == '__main__':
    ...
    X, y, statistic, statistic_label = separate_data_cifar20_balance((dataset_image, dataset_label), num_clients=N_CLIENTS, num_classes=5, mapper=mapper)
